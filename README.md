...
## I will be uploading the files for this as soon as I remove any and all private info.
...
dbsetup -       This will automatically create the necessary tables in which Verifier requires to save its data when a user verifies their assets.## Welcome to the Verifier documentation page
# Features
Reduce Asset Piracy  
Self-service asset verification  
Multi asset verification  
