...
**6.a (I originally intended on this being a compiled application, which it could be still as I have included the setup file and .spec files to compile with pyinstaller, but it is suffecient to simply run ```python3 __main__.py``` from the root directors (must be python 3.7))
